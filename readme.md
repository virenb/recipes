...
Link to the project can be found here - https://fast-hamlet-85700.herokuapp.com/
...
### Usage
![Home Screen](https://i.imgur.com/u9QnkZr.png "Home Screen")
![Saved Results Screen](https://i.imgur.com/Sr5hdHs.png "Saved Results Screen")
...
### Technologies Used
This web application was build using HTML5, CSS3, jQuery, JavaScript, and Node.js. For front end, Bootstrap 3 was utilized. For database and storage use, MongoDB, Mongoose, and mLab were used. Other tools used included npm and Express. The endpoint testing was done using Mocha and Chai. Travis CI was used for continuous integration. The app was deployed on Heroku (as seen on the above link). The data was supplied from the Food API from Spoonacular.
